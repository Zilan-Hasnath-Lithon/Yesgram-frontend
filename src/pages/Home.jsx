...
const Home = () => {
    ...
    Please <span className="text-3xl font-bold text-gray-800">Login</span> or
    <span className="text-3xl font-bold text-gray-800"> Signup</span> to enjoy personalized content.
</p>
